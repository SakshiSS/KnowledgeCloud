...
import org.GetKnowledge.Persistance.RestClient;
...
//        dataset.end();
    ...
    public static void getJsonFile(String serviceURI, String query,String path,String fileName) throws IOException {
        ...
        System.out.println("File name for json "+file.getName());
        fop = new FileOutputStream(file);

        ByteArrayOutputStream outputStream = new ByteArrayOutputStream();
        ResultSetFormatter.outputAsJSON(fop, results1);
        ...
        //sending data to rest client
        RestClient restClient = new RestClient();
        boolean success = restClient.uploadFile(file);

        System.out.println("Completed writing json file and success = "+success);
